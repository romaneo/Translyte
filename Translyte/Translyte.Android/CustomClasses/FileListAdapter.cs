...
namespace Translyte.Android.CustomClasses
{
    public class FileListAdapter : ArrayAdapter<FileSystemInfo>
    {
        ...
        public FileListAdapter(Context context, IList<FileSystemInfo> fsi)
            : base(context, Resource.Layout.FileListItemView, Android.Resource.Id.Author, fsi)
        {
            _context = context;
        }
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null)
            {
                row = _context.GetLayoutInflater().Inflate(Resource.Layout.FileListItemView, parent, false);
